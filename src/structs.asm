...
skip $7DE84C
  ...
  .XProximity: skip 0 ; $7E780C
  .waitTime: skip 2 ; $7E780C
...
struct RidleyCeres $7E7800
; TODO
endstruct

struct Ridley $7E7800
; TODO
endstruct
