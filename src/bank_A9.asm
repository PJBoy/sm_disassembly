...
;         [p + y * 2], [p + y * 2 + 1], [p + y * 2 + 10h], [p + y * 2 + 11h]
    ...
    CMP.W #$000E                                                         ;A9E89D;
    BPL +                                                                ;A9E8A0;
    LDA.W CorpseRottingGFX_Ripper0,X                                                        ;A9E8A2;
    STA.W CorpseRottingGFX_Ripper0+2,Y                                                        ;A9E8A5;
    LDA.W CorpseRottingGFX_Ripper0+$10,X                                                        ;A9E8A8;
    STA.W CorpseRottingGFX_Ripper0+$12,Y                                                        ;A9E8AB;

+   STZ.W CorpseRottingGFX_Ripper0,X                                                        ;A9E8AE;
    STZ.W CorpseRottingGFX_Ripper0+$10,X                                                        ;A9E8B1;
    LDA.W Corpse.rotEntryYOffset                                                          ;A9E8B4;
    CMP.W #$000E                                                         ;A9E8B7;
    BPL +                                                                ;A9E8BA;
    LDA.W CorpseRottingGFX_Ripper0+$20,X                                                        ;A9E8BC;
    STA.W CorpseRottingGFX_Ripper0+$22,Y                                                        ;A9E8BF;
    LDA.W CorpseRottingGFX_Ripper0+$30,X                                                        ;A9E8C2;
    STA.W CorpseRottingGFX_Ripper0+$32,Y                                                        ;A9E8C5;

+   STZ.W CorpseRottingGFX_Ripper0+$20,X                                                        ;A9E8C8;
    STZ.W CorpseRottingGFX_Ripper0+$30,X                                                        ;A9E8CB;
    LDA.W Corpse.rotEntryYOffset                                                          ;A9E8CE;
    CMP.W #$000E                                                         ;A9E8D1;
    BPL +                                                                ;A9E8D4;
    LDA.W CorpseRottingGFX_Ripper0+$40,X                                                        ;A9E8D6;
    STA.W CorpseRottingGFX_Ripper0+$42,Y                                                        ;A9E8D9;
    LDA.W CorpseRottingGFX_Ripper0+$50,X                                                        ;A9E8DC;
    STA.W CorpseRottingGFX_Ripper0+$52,Y                                                        ;A9E8DF;

+   STZ.W CorpseRottingGFX_Ripper0+$40,X                                                        ;A9E8E2;
    STZ.W CorpseRottingGFX_Ripper0+$50,X                                                        ;A9E8E5;
    RTS                                                                  ;A9E8E8;
